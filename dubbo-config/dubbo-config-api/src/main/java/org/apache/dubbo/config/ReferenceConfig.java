...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    // url for peer-to-peer invocation 直连服务提供者地址
    private String url;
    // method configs
    ...
    private void init() {
        ...
        // 直连提供者 第一优先级通过 -D 参数指定，例如 com.alibaba.xxx.XxxService=dubbo://lcoalhost:20890
        String resolve = System.getProperty(interfaceName);
        String resolveFile = null;
        // 直连提供者 第二优先级，通过文件映射，例如 com.alibaba.xxx.XxxService=dubbo://localhost:20890
        if (resolve == null || resolve.length() == 0) {
            resolveFile = System.getProperty("dubbo.resolve.file");
            // -D dubbo.resolve.file -> user.home/dubbo-resolve.properties
        ...
        // 从 ConsumerConfig 对象中，读取 application、module、registries、monitor
        if (consumer != null) {
            if (application == null) {
        ...
        // 将 side、dubbo.version、timestamp、pid
        ...
        // 以系统环境变量（DUBBO_TO_REGISTRY） 作为服务注册地址
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            ...
            // 引用服务，返回 Invoker 对象， 此处实际使用 injvm 协议
            ...
            // 但 urls 时，引用服务，返回 Invoker 对象
            if (urls.size() == 1) {
                // 引用服务, 此处 URL 为注册中心地址，固实际调用为 RegistryProtocol
                ...
                if (registryURL != null) { // registry url is available
                    ...
                    // 对有注册中心的 Cluster 只用 AvailabeCluster
