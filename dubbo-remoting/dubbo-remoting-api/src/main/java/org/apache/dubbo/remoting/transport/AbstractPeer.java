 ...
 * AbstractPeer
 *
 * 此处实现 ChannelHandler 是为了实现对 ChannelHandler 其他实现的包装
 */
public abstract class AbstractPeer implements Endpoint, ChannelHandler {
    ...
    public void send(Object message) throws RemotingException {
        send(message, url.getParameter(Constants.SENT_KEY, false)); // true 等待消息发出，消息发送失败将抛出异常 / flase 不等待消息发出，将消息放入 IO 队列，即刻返回
    }
