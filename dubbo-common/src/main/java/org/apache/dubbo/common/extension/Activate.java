...
public @interface Activate {
     ...
     * 过滤条件
     *
     * 包含 {@link ExtensionLoader#getActivateExtension(URL, String)} 的 group 参数给的值，则返回拓展
     *
     * 如果没有 group 设置，则不过滤
     */
     ...
     *
     *
     * key 过滤条件，包含 {@link ExtensionLoader#getActivateExtension(URL, String)} 的 URL 的参数 Key 中有，则返回拓展
     *
     * 实例
