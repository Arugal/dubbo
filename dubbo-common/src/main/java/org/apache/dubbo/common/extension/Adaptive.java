 ...
 * 自适应拓展信息的标记
 *
 * @Adaptive 可用在类或方法上，分别代表类两种不同的使用方式
 *
 * 1. 标记在类上，代表手动实现它是一个拓展接口的 Adaptive 拓展实现类，目前 Dubbo 项目中，只有 ExtensionFactory 拓展的实现类 AdaptiveExtensionFactory 有这么使用
 ...
 *
 *
 * ps: 一个拓展接口，有且仅有一个 Adaptive 拓展实现类
 */
@Documented
